...
public class AdiconarClienteFragmentCard extends Fragment {
    ...
    Cliente cliente;
    public AdiconarClienteFragmentCard() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_adiconar_cliente_card, container, false);
